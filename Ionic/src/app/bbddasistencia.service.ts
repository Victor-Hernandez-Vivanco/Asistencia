...
export class BBDDasistenciaService {
  ...
  updateUserState(id: any, state: any) {
    return this.http.get(`${this.apiUrl}/actualizarEstadoUsuario?idAlumno=${id}&estadoAlumno=${state}`, {});
  }

  getAllBySeccionId(id: any) {
    return this.http.get(`${this.apiUrl}/getAllBySeccionId?id=${id}`);
  }
}
